		...
		this.mockMvc.perform(
				...
				.andDo(document("Post", // 문서화할 때 사용할 경로와 이름
						requestFields( // 요청 파라미터 문서화
								...
								fieldWithPath("content_hint").description("힌트"),
								fieldWithPath("content_goal").description("목표"),
						...
						responseFields(
								...
								fieldWithPath("data.*.content_hint").type(JsonFieldType.STRING).description("게시글 내용"),
								fieldWithPath("data.*.content_goal").type(JsonFieldType.STRING).description("게시글 내용"),
