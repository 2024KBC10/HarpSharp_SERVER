...
//		RequestPostDTO requestPostDTO = new RequestPostDTO(username, title, content,memoColor, pinColor);
...
//		RequestPostDTO postDTO = new RequestPostDTO(username, title, content,memoColor, pinColor);
//
//		this.mockMvc.perform(
//						post("/board/posts")
//								.header("Authorization", "Bearer " + accessToken)
...
//		Long postId = writePost();
//        RequestUpdatePostDTO requestPostDTO = new RequestUpdatePostDTO(postId, username, "modified!", content,memoColor, pinColor);
...
//		Long postId = writePost();
//        RequestUpdatePostDTO requestPostDTO = new RequestUpdatePostDTO(postId, username, title, content,memoColor, pinColor);
